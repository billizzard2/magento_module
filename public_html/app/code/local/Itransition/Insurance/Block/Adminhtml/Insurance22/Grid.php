...
class Itransition_Insurance_Block_Adminhtml_Siteblocks_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
                ...
                array(
                    ...
                    'additional' => array('block_status' =>
                        array(
                            ...
                            'values' => Mage::getModel('siteblocks/source_status')->toArray()
                        )
                    )
                )
            );
